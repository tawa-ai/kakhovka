...
output "backend_config" {
  value = module.bootstrap.backend_terraform_snippet
}
```

## Migration to Remote State

After applying the bootstrap module, you can migrate your existing Terraform state to the newly created GCS bucket:
...
2. Run `terraform init` and respond "yes" when prompted to migrate the state.

## License

This module is licensed under the [LICENSE](../LICENSE) file.
